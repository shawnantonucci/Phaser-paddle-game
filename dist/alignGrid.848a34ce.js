...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/classes/util/alignGrid.js":[function(require,module,exports) {
...
function () {
  function AlignGrid(config) {
    ...
    this.scene = config.scene; //cell width

    this.cw = config.width / config.cols; //cell height
  ...
  _createClass(AlignGrid, [{
    ...
    value: function show() {
      ...
      for (var _i = 0; _i < this.config.height; _i += this.ch) {
        ...
        this.graphics.lineTo(this.config.height, _i);
      }
...
},{}]},{},["C:/Users/shawn/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/classes/util/alignGrid.js"], null)
//# sourceMappingURL=/alignGrid.848a34ce.map