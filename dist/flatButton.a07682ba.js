...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/classes/ui/flatButton.js":[function(require,module,exports) {
...
function (_Phaser$GameObjects$C) {
  ...
  function FlatButton(config) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FlatButton).call(this, config.scene));
    _this.config = config;
    ...
    if (config.event) {
      ...
      _this.back.on('pointerdown', _this.pressed, _assertThisInitialized(_assertThisInitialized(_this)));
    }

    if (model.isMobile == -1) {
      _this.back.on("pointerover", _this.over, _assertThisInitialized(_assertThisInitialized(_this)));

      _this.back.on("pointerout", _this.out, _assertThisInitialized(_assertThisInitialized(_this)));
    }
...
},{}]},{},["C:/Users/shawn/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/classes/ui/flatButton.js"], null)
//# sourceMappingURL=/flatButton.a07682ba.map